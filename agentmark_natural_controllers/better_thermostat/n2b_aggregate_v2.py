...
"""Aggregate exactly two independently validated N2b v2 replicas."""
...
RESULT_SCHEMA = "agentmark.natural_controller.better_thermostat_decision_equivalence.v2"
VALIDATION_SCHEMA = "agentmark.n2b.independent_validation.v2"
AGGREGATE_SCHEMA = "agentmark.n2b.replicated_aggregate.v2"
TRIALS = 6
EXPECTED_IDENTITY = {
...
def rows_exact(rows: list[dict[str, Any]]) -> bool:
    return len(rows) == 12 and all(
        row["call_counts"] == {"climate.set_preset_mode": 1}
...
def main() -> None:
    ...
    measurements = [r["measurement_contract"] for r in results]
    ...
    gates = {
        ...
        "source_native_away_exact_12_of_12": rows_exact(source_rows),
        "target_native_away_exact_12_of_12": rows_exact(target_rows),
        "target_replay_away_exact_12_of_12": rows_exact(replay_rows),
        "control_replay_away_exact_12_of_12": rows_exact(control_rows),
        "target_replay_action_support_failures_zero": target_support_failures == 0,
        ...
        "measurement_contract_identical_across_replicas": measurements[0] == measurements[1],
    }
    ...
    out = {
        ...
        "counts": {
            ...
            "target_replay_action_support_failures": target_support_failures,
            "control_replay_action_support_failures": control_support_failures,
        },
        "measurement_contract": measurements[0] if measurements[0] == measurements[1] else measurements,
